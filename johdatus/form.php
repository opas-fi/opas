...
if (array_key_exists('to', $_POST)) {
    ...
    if (array_key_exists('to', $_POST) && in_array($_POST['to'], ['islamopas', 'islamopas', 'islamopas'], true)) {
        $to = $_POST['to'] . '@protonmail.com';
    } else {
        $to = 'islamopas@protonmail.com';
    }
    ...
    if (!$err) {
        ...
        $mail->setFrom('islamopas@protonmail.com', (empty($name) ? 'Contact form' : $name));
        $mail->addAddress($to);
